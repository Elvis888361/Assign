...
<div class="sm:grid grid-cols-2 gap-20 w-4/5 mx-auto py-15 border-b border-gray-200">
    ...
    <div>
        ...
        {{$post->user_id}}
        <p class="text-xl text-gray-700 pt-8 pb-10 loadint-8 font-light">
            {{$post->description}}
        </p>
        <a href="/blog/{{$post->slug}}"class="upperclass bg-blue-500 text-gray-100 text-lg font-extrabold py-4 px-8 rounded-3xl">Keep Reading</a>
